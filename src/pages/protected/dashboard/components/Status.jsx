                    ...
                    <Table striped bordered hover responsive>
                        ...
                        <tbody>
                            ...
                            return <tr key={user.id} className='text-center'>
                                ...
                                <td className='text-center'><button className="btn btn-success" onClick={()=>updateUserData(user.id, {status: 'accepted'})}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check" viewBox="0 0 16 16">
                                        <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                                    </svg>
                                </button>
                                {"  "}
                                <button className="btn btn-danger" onClick={()=>updateUserData(user.id, {status: 'reject'})}>
                    ...
                    <Table striped bordered hover responsive>
                        ...
                        <tbody>
                            ...
                            return <tr key={user.id} className='text-center'>
                                ...
                                <td>{user.status}</td>
                                <td className='text-center'>{user.roleId}</td>
                                <td className='text-center'><button color="btn btn-info" onClick={()=> this.setState({show: !this.state.show}), ()=>this.catchUser(user)}>
